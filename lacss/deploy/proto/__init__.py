...
from biopb.image.rpc_object_detection_pb2_grpc import ObjectDetectionServicer as LacssServicer
from biopb.image.rpc_object_detection_pb2_grpc import ObjectDetectionStub as LacssStub
from biopb.image.rpc_object_detection_pb2_grpc import add_ObjectDetectionServicer_to_server as add_LacssServicer_to_server
