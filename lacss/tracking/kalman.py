...
class KalmanFilter(Protocol):
    ...
    def update(
        self, mean: Any, covariance: Any, measurement: Any
...
class KTracker:
    ...
    def __init__(
        self, init_obs: ArrayLike, frame_id: int, kf: KalmanFilter, *, data: dict = {}
    ):
        """constructor
    ...
    def assign(
        ...
        """
        matches, unmatched_track_ids, unmatched_det_ids = linear_assignment(
